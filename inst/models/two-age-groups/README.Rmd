...
The contact rates, $c_{ij}$, and the transmission rates, $\beta_j$ are specified for each age group with the `params` value (a named list), in the entries whose names start with `c_` and `transmission_`, respectively. 
