...
The goal of `EPACmodel` is to package, document, and version different iterations of the Early Pandemic Age-structured Compartmental model so that it is easy to call a model iteration into a pipeline that produces a specific modelling output. 
...
This package includes several models whose simulators can quickly and easily be retrieved. Package models include:
